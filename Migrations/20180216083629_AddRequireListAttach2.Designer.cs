...
namespace VipcoPainting.Migrations
{
    ...
    [Migration("20180216083629_AddRequireListAttach2")]
    partial class AddRequireListAttach2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VipcoPainting.Models.AttachFile", b =>
                {
            ...
            modelBuilder.Entity("VipcoPainting.Models.BlastWorkItem", b =>
                {
                    ...
                    b.Property<int?>("InitialRequireId");
            ...
            modelBuilder.Entity("VipcoPainting.Models.InitialRequirePaintingList", b =>
                {
                    b.Property<int>("InitialRequireId")
                        .ValueGeneratedOnAdd();
                    ...
                    b.HasKey("InitialRequireId");

                    b.HasIndex("RequirePaintingMasterId")
                        .IsUnique()
                        .HasFilter("[RequirePaintingMasterId] IS NOT NULL");

                    b.ToTable("InitialRequirePaintingList");
                });
            ...
            modelBuilder.Entity("VipcoPainting.Models.BlastWorkItem", b =>
                {
                    b.HasOne("VipcoPainting.Models.InitialRequirePaintingList", "InitialRequirePaintingList")
                        .WithMany("BlastWorkItems")
                        .HasForeignKey("InitialRequireId");
            ...
            modelBuilder.Entity("VipcoPainting.Models.InitialRequirePaintingList", b =>
                {
                    b.HasOne("VipcoPainting.Models.RequirePaintingMaster", "RequirePaintingMaster")
                        .WithOne("InitialRequirePaintingList")
                        .HasForeignKey("VipcoPainting.Models.InitialRequirePaintingList", "RequirePaintingMasterId");
                });
            ...
            modelBuilder.Entity("VipcoPainting.Models.RequirePaintingListHasAttach", b =>
                {
                    b.HasOne("VipcoPainting.Models.AttachFile", "AttachFile")
                        .WithMany()
