...
namespace VipcoPainting.Services.Classes
{
    public class RepositoryPainting<TEntity> : IRepositoryPainting<TEntity> where TEntity : class
    {
        ...
        public RepositoryPainting(PaintingContext context)
        {
